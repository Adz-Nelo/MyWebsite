...
ScrollReveal().reveal('#header h1, .gallery-item, .achievement-card a img, .masonry-item, .bookbind figure, .link-container, .image-grid, .group-members-box figure', {origin: 'bottom'});